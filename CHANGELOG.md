...
### 📝 Documentation
- 📄 Ajout ou mise à jour de tous les fichiers de documentation (README, API, ARCHITECTURE, SECURITY, CONTRIBUTING, etc.)
- ✅ Ajout d'une checklist accessibilité et d'une politique de mise à jour sécurité
- 🔒 Ajout d'avertissements XSS dans le code JS
- 🚀 Automatisation des tests unitaires et de la vérification sécurité via GitHub Actions
- 📦 Déplacement du fichier CHANGELOG.md à la racine du dépôt
